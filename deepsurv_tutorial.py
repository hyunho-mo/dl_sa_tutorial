...
# ~/hmo/dl_sa_tutorial/experiments/data/whas/whas_train_test.h5
# ~/hmo/dl_sa_tutorial/experiments/deepsurv/models/whas_model_selu_0.json
...
def main():
    ...
    if args.model is not None:
        deepsurv_model = args.model
    else:
        # Create a pre-defined deepsurv model 
